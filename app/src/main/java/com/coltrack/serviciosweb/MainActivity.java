package com.coltrack.serviciosweb;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText direccion;
    TextView resultado;
    String LOGTAG="Monitor";


    // IP de mi Url
    //String IP = "http://frangarcia.esy.es";
    String IP = "http://107.170.62.116/tutorial";
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String>{
        ...
        protected String doInBackground(String... params) {
            ...
            Log.d(LOGTAG,"Params[1]: "+params[1]);

            if(params[1]=="1"){    // Consulta de todos los alumnos
                Log.i(LOGTAG,"Url WebService: "+cadena);
                try {
                    url = new URL(cadena);
                    ...
                    Log.d(LOGTAG,"respuesta: "+respuesta);
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK){
                        ...
                        Log.i(LOGTAG,"resultJSON:"+resultJSON);
                        ...
                        if (resultJSON.equals("1")){      // hay alumnos a mostrar
                            ...
                            Log.i(LOGTAG,"alumnosJSON.length: "+alumnosJSON.length());
                            ...
                            Log.i(LOGTAG,"Devuelve: "+devuelve);

                        }
                        else if (resultJSON=="2"){
                            devuelve = "No hay alumnos";
                            Log.i(LOGTAG,"No hay alumnos");
                        }else{
                            Log.i(LOGTAG,"Problema");
                        }
